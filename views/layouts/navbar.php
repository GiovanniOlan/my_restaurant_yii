...
<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
    <div class="container-fluid">
        <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" style="font-size: 20px; padding-left: -5px;" href="/">Mi Restaurante </a>
        </div>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-navbar">
                        <li class="nav-link"><a href="javascript:void(0)" class="nav-item dropdown-item">Mi perfil</a>
                        </li>
                        <!-- <li class="nav-link"><a href="javascript:void(0)" class="nav-item dropdown-item">Settings</a>
                        </li> -->
                        <li class="dropdown-divider"></li>
                        <?php if (!Yii::$app->user->isGuest) : ?>
                            <li class="nav-link"><a href="/user-management/auth/logout" class="nav-item dropdown-item">Log out</a></li>
                        <?php endif ?>

                        <?php if (Yii::$app->user->isGuest) : ?>
                            <li class="nav-link"><a href="/user-management/auth/login" class="nav-item dropdown-item">Login</a></li>
                        <?php endif ?>
